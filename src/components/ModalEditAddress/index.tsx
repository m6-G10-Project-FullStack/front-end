...
port Select from "../Select";
port { Button } from "../Button";
port Input from "../Input";
port * as yup from "yup";
port { useForm } from "react-hook-form";
port { yupResolver } from "@hookform/resolvers/yup";
port { Schema } from "inspector";
port { RxDragHandleDots1 } from "react-icons/rx";
port api from "../../services/api";
port { AuthContext, useAuth } from "../../contexts/authContext";
port { iUser } from "../../@types";

port interface iUserEdit {
id?: string;
name?: string;
email?: string;
cpf?: string;
...
port default ModalEditAddress;




3 className="text-1xl font-semibold text-gray-800 m-2">
